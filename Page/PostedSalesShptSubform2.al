page 50068 "Posted Sales Shpt. Subform2"
{
    AutoSplitKey = true;
    Caption = 'Lines';
    Editable = false;
        ...
        area(processing)
        {
            ...
            group("&Line")
            {
                ...
                action("Update Document")
                {
                    ...
                    trigger OnAction()
                    var
                        PostedSalesShpLineUpdate: Page "Posted Sales ShpLine - Update";
                    begin
                        PostedSalesShpLineUpdate.LookupMode := true;
                        PostedSalesShpLineUpdate.SetRec(Rec);
                        PostedSalesShpLineUpdate.RunModal();
                    end;
                }
            }
        }
