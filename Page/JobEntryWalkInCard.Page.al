page 70084 "Job Entry Walk In Card"
{
        ...
        area(navigation)
        {
            action("Generate COF")
            {
                ...
                begin
                    ...
                    /*
                    SerAppSch.GET(CustOrderLine."Customer Order Form No.");Rec. //Dada: To prevent the error msg.
    ...
    begin
        Rec."Walk-In" := TRUE;
        Rec."Customer's Requests" := Rec."Customer's Requests"::"Walk-In";
        Rec."For Appt Confirmation" := FALSE;
    end;
}
