...
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Layout/CustomerOrderFormReport.rdl';

    dataset
    {
        dataitem(DataItem1000000000; "Customer Order Table.")
        {
            column(CustomerOrderFormNo_CustomerOrderTable; "Customer Order Form No.")
            {
            }
            ...
            column(GSM_CustomerOrderTable; GSM)
            {
            }
            ...
            dataitem(DataItem1000000012; "Customer Order Line")
            {
                DataItemLink = "Customer Order Form No." = FIELD("Customer Order Form No.");
                column(CustomerOrderFormNo_CustomerOrderLine; "Customer Order Form No.")
                {
                }
                ...
                column(Quantity_CustomerOrderLine; Quantity)
                {
                }
                ...
                column(LineType_CustomerOrderLine; "Line Type")
                {
                }
                ...
                column(Variant_CustomerOrderLine; Variant)
                {
                }
                column(AvailableQuantity_CustomerOrderLine; "Available Quantity")
                {
                }
                ...
                column(JobInstructionNo_CustomerOrderLine; "Job Instruction No.")
                {
                }
                column(JobDetailsReplacedParts_CustomerOrderLine; "Job Details / Replaced Parts")
                {
                }
                ...
                column(ServiceType_CustomerOrderLine; "Service Type")
                {
                }
                ...
                column(ServiceOrder_CustomerOrderLine; "Service Order")
                {
                }
                ...
                column(ModelName_CustomerOrderLine; "Model Name")
                {
                }
