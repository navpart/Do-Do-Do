report 50215 "Stock Transactn statmt.TSP2002"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Layout/StockTransactnstatmtTSP2002.rdl';
    ...
    begin
        ...
        ItemLedgEntry.SETRANGE("Item No.", ItemData."No.");
        ItemLedgEntry.SETFILTER("Variant Code", ItemData.GETFILTER("Variant Filter"));
        ItemLedgEntry.SETFILTER("Location Code", ItemData.GETFILTER("Location Filter"));
        ItemLedgEntry.SETFILTER("Global Dimension 1 Code", ItemData.GETFILTER("Global Dimension 1 Filter"));
        ItemLedgEntry.SETFILTER("Global Dimension 2 Code", ItemData.GETFILTER("Global Dimension 2 Filter"));
