...
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Layout/JobInstructionRetail.rdl';
    ...
    dataset
    {
        dataitem(DataItem7672; "Customer Order HeaderX")
        {
            ...
            column(OdometerAtReception_CustomerOrderHeaderX; "Odometer At Reception")
            {
            }
    ...
    var
        ...
        SignCaptionLbl: Label 'Signature: _____________________________________________';
        DateaptionLbl: Label 'Date / Time: ________________________________________';
