...
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Layout/JournalVoucherMult.rdl';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem(DataItem5195; "Payment/Receipt.")
        {
            ...
            column(AccountNo_PaymentReceipt; "Account No.")
            {
            }
            ...
            column(VoucherType_PaymentReceipt; "Voucher Type")
            {
            }
            column(ExternalDocumentNo_PaymentReceipt; "External Document No.")
            {
            }
            ...
            dataitem(DataItem1385; "Payment/Receipt Bal. Line.")
            {
                ...
                column(AmountLCY_PaymentReceiptBalLine; "Amount (LCY)")
                {
                }
                ...
                column(ApplyEntry_PaymentReceiptBalLine; "Apply Entry")
                {
                }
