report 50639 "Inventory Valuation-BnP"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Layout/InventoryValuationBnP.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'Inventory Valuation-BnP';
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            column(BNPA_Item; Item.BNPA)
            {
            }
            column(BNPB_Item; Item.BNPB)
            {
            }
            column(BNPC_Item; Item.BNPC)
            {
            }
            ...
            column(BNPGrouping_Item; Item."BNP Grouping")
            {
            }
