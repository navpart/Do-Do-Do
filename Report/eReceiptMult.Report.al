...
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Layout/eReceiptMult.rdl';

    dataset
    {
        dataitem(PaymentReceipt; "Payment/Receipt.")
        {
            ...
            column(AccountDescription_PaymentReceipt; "Account Description")
            {
            }
            ...
            dataitem(PaymentReceiptLine; "Payment/Receipt Bal. Line.")
            {
                ...
                column(AmountLCYBalLine; ABS("Amount (LCY)"))
                {
                }
